                ...
                <div class="card-body">
                    ...
                    <form id="formMedicine">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" value="@if(isset($edit)){{$medicine->id}}@endif" placeholder="Kode Obat" aria-label="Kode Obat" id="kodeObat" aria-describedby="basic-addon2">
                            @if(!isset($edit))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="@if(isset($edit)){{$medicine->namaobat}}@endif" id="namaObat" placeholder="OBH Combine">
                        </div>
